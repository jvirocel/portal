...
<head>
    ...
    <style>
        ...
        .hero-section {
            background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://eos.com/wp-content/uploads/2024/10/growing-tobacco-main.jpg.webp');
                ...
                <div class="col">
                    <div class="card service-card text-center h-100">
                        <div class="card-body">
                            ...
                            <a href="<?php echo htmlspecialchars($service['link']); ?>" class="btn btn-outline-primary">View Service</a>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
                ...
                <div class="col-md-4">
                    <div class="card news-card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Latest updates on ongoing city development projects and infrastructure improvements.</p>
                ...
                <div class="col-md-4">
                    <div class="card news-card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Important health updates and advisories from the City Health Office.</p>
                            <a href="#" class="btn btn-primary">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card news-card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Upcoming city events, festivals, and important dates to remember.</p>
                            <a href="#" class="btn btn-primary">Read More</a>
                        </div>
                    </div>
                </div>
