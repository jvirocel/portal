...
map.getView().fit([13401893.282241, 1937248.349886, 13420271.240744, 1948994.503806], map.getSize());
...
window.onerror = function(msg, url, lineNo, columnNo, error) {
    ...
    alert('Sorry, there was an error loading the map. Please try refreshing the page.');
    return false;
};