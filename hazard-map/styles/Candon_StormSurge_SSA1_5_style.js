...
var style_Candon_StormSurge_SSA1_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("HAZ");
    var labelText = "";
    size = 0;
    ...
    if (value >= 1.000000 && value <= 1.400000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1.800000 && value <= 2.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.200000 && value <= 2.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.600000 && value <= 3.000000) {
            style = [ new ol.style.Style({
