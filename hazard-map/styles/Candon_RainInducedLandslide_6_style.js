var size = 0;
var placement = 'point';
function categories_Candon_RainInducedLandslide_6(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'LL':
...
var style_Candon_RainInducedLandslide_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_Candon_RainInducedLandslide_6(feature, value, size, resolution, labelText,
